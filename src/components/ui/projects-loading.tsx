...
export default function ProjectsLoading() {
    return (
        <div className="flex w-full flex-col items-center text-white gap-10">
            <div className="flex h-fit w-full max-w-5xl flex-col items-center justify-center gap-4 p-4 md:flex-row md:items-start md:justify-start bg-accent/40 rounded-xl">
